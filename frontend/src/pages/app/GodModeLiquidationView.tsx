                    ...
                    <Card className="flex-1 bg-gradient-to-b from-[#090E17] to-[#05080F] border-brand-primary/20 p-0 relative overflow-hidden group shadow-[0_0_30px_rgba(0,0,0,0.8)] flex flex-col">
                        ...
                        <div className="flex-1 mt-14 sm:mt-12 relative flex justify-between">
                             ...
                             <div className="flex-1 relative bg-black/50">
                                  ...
                                  <LiquidationRenderer chart={chartRef.current} series={seriesRef.current} data={state as any} showBubbles={true} intensityScale={100} useTrailingLiquidity={trailingLiquidityEnabled} showTrueCVD={true} showSpoofing={true} showGEX={true} showBookmap={true} bookmapIntensity={50} spoofingThreshold={500000} />
                             </div>
